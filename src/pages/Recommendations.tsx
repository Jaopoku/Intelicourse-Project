    ...
    return (
      <div className="min-h-screen bg-arcade-dark flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Finding your perfect course matches</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-arcade-dark">
      ...
      <header className="container mx-auto px-4 py-6 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">Smart Course Recommendations</p>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mt-16">
          <div className="bg-arcade-terminal/40 backdrop-blur-sm rounded-xl p-8 border border-gray-800 max-w-2xl mx-auto">
            ...
            These recommendations are based on your responses and carefully matched with course descriptions to find the best fit for your interests and goals.
            </p>
      ...
      <footer className="mt-16 py-8 border-t border-gray-800">
        <div className="container mx-auto px-4 text-center text-gray-400">
          <p>&copy; 2025 InteliCourse. Smart course recommendations.</p>
        </div>
      </footer>
    </div>
  );
